...
namespace DoctorManagement.Controllers
{
    public class HospitalsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,HospitalName,Adress,PhoneNumber,Nation")] Hospital hospital)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,HospitalName,Adress,PhoneNumber,Nation")] Hospital hospital)
        {
            if (ModelState.IsValid)
            {
